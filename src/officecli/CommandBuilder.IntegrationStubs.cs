...
static partial class CommandBuilder
{
    ...
    private static readonly Dictionary<string, string> StubBlurbs =
        new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["issue"]   = "Open or read repo ledger issues, bug or improvement with acceptance (ledger.ohmygh.com). Run 'officecli help issue' for full usage.",
            ["artifact"] = "Publish or attest repo ledger artifacts, the shared library of verified products. Run 'officecli help artifact' for full usage.",
        };
